...
public class ChineseCharacterUtil {
    ...
    public static String getFirstCharPinyinUpCase(String name){
        char f=name.charAt(0);
        if(match(String.valueOf(f),"^[\u4E00-\u9FFF]+$")){  //如果是汉字 就转化
            return String.valueOf(convertSingleHanzi2Pinyin(f).toUpperCase().charAt(0));
        }else {
